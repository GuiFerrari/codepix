...
import (
	"fmt"
	"github.com/GuiFerrari/codepix-go/application/factory"
	appmodel "github.com/GuiFerrari/codepix-go/application/model"
	"github.com/GuiFerrari/codepix-go/application/usecase"
